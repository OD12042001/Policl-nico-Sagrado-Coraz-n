...
@Repository
public class HorarioDAOImpl implements HorarioConsultaRepository, HorarioComandoRepository {
    private final JdbcTemplate jdbc;

    public HorarioDAOImpl(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
    ...
    // obtiene todos los horarios filtrados por fecha y de la hora actual para
    // adelante
    @Override
